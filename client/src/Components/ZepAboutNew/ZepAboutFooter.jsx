      ...
      <footer className="footer-full">
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-contact-item"><div className="footer-contact-icon ink"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" /></svg></div><div className="footer-contact-text"><strong>Global HQ</strong>56 Weighton Road, Harrow, London, United Kingdom</div></div>
