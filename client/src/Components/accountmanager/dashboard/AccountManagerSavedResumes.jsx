...
const AccountManagerSavedResumes = ({ jobId, onBack, jobtitle }) => {
  ...
  const fetchResumes = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/accountmanager/resumes/job/${jobId}`, {
        headers: {
      ...
      console.log('AccountManagerSavedResumes - fetched data:', data);
  ...
  const handleSaveNote = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/accountmanager/resumes/${noteSidebar.resume._id}`, {
        method: 'PATCH',
        headers: { 
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
...
export default AccountManagerSavedResumes; 