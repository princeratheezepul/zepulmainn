...
const AccountManagerJobDetails = ({ job, onBack, onShowCandidates, onJobUpdated }) => {
      ...
      <div className="bg-blue-50 rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="font-semibold">
              {job.adminId?.fullname || job.managerId?.fullname || job.accountManagerId?.fullname || 'Unknown'}
            </p>
          </div>
          <div>
            <p className="text-gray-600">Role:</p>
            <p className="font-semibold">
              {job.adminId ? 'Admin' : job.managerId ? 'Manager' : job.accountManagerId ? 'Account Manager' : 'Unknown'}
            </p>
          </div>
          <div>
...
export default AccountManagerJobDetails; 