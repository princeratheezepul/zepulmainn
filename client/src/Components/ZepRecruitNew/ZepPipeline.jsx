  ...
  return (
    <div id="ZepPipeline-root" className="zep-recruit-page">
      <section className="zrw">
        ...
        <div className="zrw-canvas-wrapper">
          <div className="zrw-canvas reveal">

            {/*  1. ENGAGEMENT MODELS (Offerings)  */}
            <div className="zrw-offerings" style={{ width: '200px' }}>
              ...
              <div className="zrw-offering-chip">
            ...
            <div className="zrw-zepdb" style={{ animation: 'nodeGlow 3s ease-in-out 1s infinite' }}>
              ...
              <div>
                <div className="zrw-zepdb-label">ZepDB</div>
                <div className="zrw-zepdb-sub">Unified Data Layer</div>
              </div>
            </div>

            <div className="zrw-arrow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7" /></svg></div>

            {/*  3. SOURCING + downward services branch  */}
            ...
            <div className="zrw-cv-group">
              ...
              <div className="zrw-cv-row">
                <div className="zrw-cv-node">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z" /><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z" /></svg>
                  <div className="zrw-cv-node-label">Read</div>
                </div>
                <div className="zrw-cv-node">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>
                  <div className="zrw-cv-node-label">Rank</div>
                </div>
                <div className="zrw-cv-node">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
                  <div className="zrw-cv-node-label">Match</div>
                </div>
              </div>
            </div>
            ...
            {/*  7. AI PERSPECTIVE + HUMAN VALIDATION (parallel)  */}
            ...
            {/*  8. COMPREHENSIVE DECISION-READY REPORT CARD  */}
            ...
            {/*  9. ACCOUNT + INTERVIEW MGMT (parallel)  */}
            <div className="zrw-split">
            ...
            {/*  11. BENCHMARKING + NEGOTIATION (parallel final outputs)  */}
            <div className="zrw-split">
