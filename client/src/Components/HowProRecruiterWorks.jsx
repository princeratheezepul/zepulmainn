...
import '../styles/HowProRecruiterWorks.css';

const HowProRecruiterWorks = () => {
    return (
        <div className="how-pro-recruiter-works-container">
            ...
            <div className="how-pro-recruiter-works-right">
                <p>
                    ...
                    recruitment partners worldwide Zepul delivers hiring at scale.
                </p>
            </div>
        </div>
    );
...
export default HowProRecruiterWorks;
