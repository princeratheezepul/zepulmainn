    ...
    return (
        <section className="lp-beyond">
            <div className="lp-beyond-left lp-reveal">
                <div>
                    <h2 className="lp-section-head">Beyond recruitment, we architect talent <span className="lp-blue">intelligently, instantly, and at scale.</span></h2>
                ...
                <div className="lp-beyond-social">
