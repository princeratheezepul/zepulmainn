    ...
    <section className="lp-beyond">
      <div className="lp-beyond-left lp-reveal">
        <div>
          ...
          <p style={{ fontSize: '15px', lineHeight: '1.75', color: '#ffffff', marginTop: '30px', maxWidth: '420px', fontWeight: '500' }}>
          ...
          <button
            ...
            style={{ marginTop: '32px', width: 'fit-content', padding: '14px 40px' }}
