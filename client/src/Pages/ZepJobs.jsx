...
const ZepJobs = () => {
  ...
  // Interview prep is a candidate-only feature — send anyone who isn't signed
  // in to the candidate login before they can open the tab.
  const handlePrepTabClick = () => {
    if (!getLoggedInCandidate()) {
      toast('Please log in as a candidate to get free interview prep.', { icon: 'ℹ️' });
