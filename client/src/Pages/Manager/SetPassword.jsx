...
const SetPassword = () => {
  ...
  const validateToken = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/manager/validate-set-password/${id}/${token}`, {
        method: 'GET',
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/manager/set-password/${id}/${token}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
