...
function AccountManagerResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/accountmanager/reset-password/${id}/${token}`,
        {
          method: 'POST',
          headers: {
...
export default AccountManagerResetPassword;
