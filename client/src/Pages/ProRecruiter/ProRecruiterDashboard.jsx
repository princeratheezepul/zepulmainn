...
import ProRecruiterSidebar from '../../Components/prorecruiter/dashboard/ProRecruiterSidebar';
...
export default function ProRecruiterDashboard() {
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <div
        className={`flex-1 h-screen overflow-y-auto transition-all duration-300 ${isCollapsed ? "ml-20" : "ml-52"
          }`}
      >
